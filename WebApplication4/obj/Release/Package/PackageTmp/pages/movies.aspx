...
right:0;top:60%;"/>
  ...
  <div class="row" style="">
    <div class="col-12 col-md-6 col-lg-6" data-aos="fade-right"  data-aos-duration="2000" style="margin-block:2rem;">
      <h1 style="font-size:55px;">Diverse Movies</h1>
        <h4 style="font-size:25px; margin-block:2rem;"> We have a variety of films that are suitable <br /> for all ages of children</h4>
    ...
    <div class="col-12 col-md-6 col-lg-6"  data-aos="fade-left"  data-aos-duration="2000">
      <div style="display:flex;align-items:center;gap:1rem; position:relative;">
          <img src="../assets/movies_header.jpg" alt="image1" style="width:100%;max-height:400px;height:400px; z-index:100""/>
      ...
      <div class="container" style="padding:2rem 0;" >
                <h1 style="text-align:center;margin:1rem 0;color:#0e1133;">Movies</h1>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Title], [Description], [Path], [Image] FROM [movies]"></asp:SqlDataSource>
                    </div></div>
