<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/Layout.Master" AutoEventWireup="true" CodeBehind="songs.aspx.cs" Inherits="WebApplication4.songs" %>
...
<div class="form-group">
    ...
    <h1 style="margin:10px; direction: ltr;">Songs Mangament</h1>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalLabel">Insert song</h5>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [songs]" DeleteCommand="DELETE FROM [songs] WHERE [Id] =@Id" UpdateCommand="UPDATE [songs] SET [Title] = @Title, [Path] = @Path WHERE [Id] = @Id"></asp:SqlDataSource>
